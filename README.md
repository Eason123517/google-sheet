...
B777 中央裝載的 packing surface 改為維持 ULD 原始尺寸：
...
中央裝載後仍是 `310 × 236`，不再變成 `310 × 472`。

中央裝載只會把 ULD 的橫向中心對準 aircraft centerline。
貨物高度仍依每件貨物實際的 aircraft Y 位置查 B777 contour。

既有 aircraft position 占用數與中央裝載盤位規則維持不變。
